...
public interface EmpresaDao {
    ...
    /**
     * Este metodo recupera los clientes/proveedores de una empresa en particular
    ...
    /**
     * Recupera todos los estantes en los que estan alojados los items para una sucursal en particular
     * @param idSucursal Identificador de la sucursal seleccionada de la empresa que esta en sessión
     * @return 
     */
